...
#define LSP_PLUGINS_AB_TESTER_VERSION_MICRO       0
...
namespace lsp
{
    namespace meta
    {
        ...
        static const port_t ab_tester_mono_ports[] =
        {
            ...
            // Input controls
            BYPASS,
            INT_CONTROL("d_in", "Delay in samples", U_SAMPLES, ab_tester::SAMPLES),
            DRY_GAIN(0.0f),
            WET_GAIN(1.0f),
            OUT_GAIN,

            // Output controls
            METER_MINMAX("d_out", "Delay time in milliseconds", U_MSEC, 0.0f, ab_tester::DELAY_OUT_MAX_TIME),
        ...
        // NOTE: Port identifiers should not be longer than 7 characters as it will overflow VST2 parameter name buffers
        static const port_t ab_tester_stereo_ports[] =
        {
            // Input and output audio ports
            PORTS_STEREO_PLUGIN,
        ...
        const plugin_t ab_tester_stereo =
        {
            ...
            &developers::v_sadovnikov,
            "ab_tester_stereo",
            LSP_LV2_URI("ab_tester_stereo"),
            LSP_LV2UI_URI("ab_tester_stereo"),
            "yyyy",         // TODO: fill valid VST2 ID (4 letters/digits)
            2,              // TODO: fill valid LADSPA identifier (positive decimal integer)
            LSP_LADSPA_URI("ab_tester_stereo"),
            LSP_CLAP_URI("ab_tester_stereo"),
            LSP_PLUGINS_AB_TESTER_VERSION,
            plugin_classes,
            clap_features_stereo,
            E_DUMP_STATE,
            ab_tester_stereo_ports,
            "template/plugin.xml",
            NULL,
